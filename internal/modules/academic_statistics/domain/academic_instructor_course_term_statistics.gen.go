...
// AcademicInstructorCourseTermStatistic is the persistent domain entity for the academic_statistics module.
type AcademicInstructorCourseTermStatistic struct {
	...
	TeacherKey          string    `gorm:"column:teacher_key;not null" json:"teacher_key"`
	TeacherName         string    `gorm:"column:teacher_name;not null" json:"teacher_name"`
	ClassCount          int64     `gorm:"column:class_count;not null" json:"class_count"`
...
func (AcademicInstructorCourseTermStatistic) TableName() string {
	return "academic_instructor_course_term_statistics"
}
